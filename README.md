...
> **Fork từ [homielab/giapha-os](https://github.com/homielab/giapha-os)** — Phát triển và mở rộng bởi [minhtuancn](https://github.com/minhtuancn/giapha-os).
...
### Nhà phát triển (Fork maintainer)

**Tên:** Minh Tuấn — Ninh Bình, Việt Nam  
...
Dự án này được fork từ **[homielab/giapha-os](https://github.com/homielab/giapha-os)** và phát triển thêm nhiều tính năng mới (xem [Changelog](docs/wiki/Changelog.md) để biết chi tiết các thay đổi).
...
- Bản quyền gốc: © 2024 [homielab](https://github.com/homielab/giapha-os)
- Bản quyền fork: © 2025–2026 [Minh Tuấn (minhtuancn)](https://github.com/minhtuancn/giapha-os)
