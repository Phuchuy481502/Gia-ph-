...
### Phase 11 — i18n + AI Bot Module (✅ Xong) — v1.5

| Issue | Tính Năng | PR |
|-------|-----------|-----|
| #81 | 🌐 i18n Foundation — 211 keys, 12 namespaces, 3 locales | #87 |
| #82 | 🤖 Per-branch Telegram Bot — webhook, commands, admin UI | #88 |
| #83 | 🧠 AI Chat — BYOK + platform key, OpenAI/Anthropic/OpenRouter/LiteLLM | #89 |
| #84 | ⏰ Scheduled Reminders — giỗ 3x, sự kiện, sinh nhật, Vercel cron | #90 |
| #85 | 🔑 Subscription & Rate Limiting — quota tháng, /admin panel | #91 |
| #86 | 🌐 Zalo OA & Multi-platform — BotPlatform interface, Zalo webhook | #91 |
